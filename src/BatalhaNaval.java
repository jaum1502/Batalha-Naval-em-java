...
public class BatalhaNaval {
    public BatalhaNaval() throws InterruptedException, IOException {
        ...
        } while (qtdPC > 0 && qtdJogadas < 30); // Continua até que o jogador ganhe ou atinja o limite de jogadas (30 é o limite)
        if (qtdPC==0) {
   ...
   // Método para imprimir o tabuleiro com cores diferentes para cada tipo de célula
public void impressaoMatrizes(int matriz2[][], int qtdPC, int qtdPCNova) {
    ...
    public void espacoBranco() {
        ...
        // Cria várias linhas em branco para simular a limpeza do terminal
        for (int i = 0; i < 10; i++) {
            System.out.println("");
        }
    }
